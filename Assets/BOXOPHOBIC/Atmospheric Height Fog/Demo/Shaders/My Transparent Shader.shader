...
Shader "Custom/My Transparent Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 gammaToLinear3_g748 = GammaToLinearSpace( temp_output_2_0_g748 );
			#ifdef UNITY_COLORSPACE_GAMMA
			...
			#endif //aseld
			float dotResult6_g749 = dot( normalizeResult5_g749 , ase_worldlightDir );
			...
			float simplePerlin3D15_g756 = snoise( ( ( WorldPosition2_g703 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _Time.y ) ) );
...
/*ASEBEGIN
Version=17802
1927;7;1906;1014;629.8051;-371.3512;1.686412;True;False
...
ASEEND*/
//CHKSM=93DB93775ED057247FF82917F0EF0376FBC80CAB